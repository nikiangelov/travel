  ...
  return (
    <AnimatedLayout>
      <div className="row">
        <div className="col">
          <PageSection
            title={i18n.t('pages.index.popular-destinations-abroad')}
          >
            <PopularDestinationsGrid />
          </PageSection>
          <PageSection
            title={i18n.t('pages.index.travel-ideas-bulgaria-abroad')}
            titleRightComponent={(): ReactElement => (
              <button className="btn btn-sm btn-light mb-2">Виж всички</button>
            )}
          >
